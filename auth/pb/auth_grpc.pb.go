...
const (
	AuthService_RegisterUser_FullMethodName  = "/library.AuthService/RegisterUser"
	AuthService_LoginUser_FullMethodName     = "/library.AuthService/LoginUser"
	AuthService_ValidateToken_FullMethodName = "/library.AuthService/ValidateToken"
)
...
type AuthServiceClient interface {
	...
	ValidateToken(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*UserData, error)
}
...
func (c *authServiceClient) ValidateToken(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*UserData, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserData)
...
type AuthServiceServer interface {
	...
	ValidateToken(context.Context, *ValidateRequest) (*UserData, error)
...
func (UnimplementedAuthServiceServer) ValidateToken(context.Context, *ValidateRequest) (*UserData, error) {
